...
<html lang="zh-CN">
	...
	<body>
		<div class="col-xs-8 col-md-9 col-lg-12">
                   ...
                   %> 
									    	<tr>
									    		<td style="border-left:#D8E7F6 1px solid;"><input type="text" class="form-control"  id="id" name="id" placeholder="0" value="<%=goods.getGoodsID() %>" disabled></td></td>					
												...
												<td> <input type="submit"  value="上架" ></td>
												<%}%>
